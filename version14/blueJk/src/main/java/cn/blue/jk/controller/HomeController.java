...
public class HomeController {
    ...
    public String cargoMain(){
        logger.info("/cargoMain.action");
        logger.info(VIEW.Pages.getVar() + "cargo/main" + VIEW.JSP.getVar());
        return VIEW.Pages.getVar() + "cargo/main" + VIEW.JSP.getVar();
    }

    @RequestMapping(value = "/cargoLeft.action")
    public String cargoLeft(){
        logger.info("/cargoLeft.action");
        logger.info(VIEW.Pages.getVar() + "cargo/left" + VIEW.JSP.getVar());
        return VIEW.Pages.getVar() + "cargo/left" + VIEW.JSP.getVar();
    }

    //系统模块
    @RequestMapping(value = "/sysMain.action")
    public String sysMain(){
        logger.info(VIEW.Pages.getVar() + "sys/main" + VIEW.JSP.getVar());
        logger.info("/sysMain.action");
        return VIEW.Pages.getVar() + "sys/main" + VIEW.JSP.getVar();
    }

    @RequestMapping(value = "/sysLeft.action")
    public String sysLeft(){
        logger.info(VIEW.Pages.getVar() + "sys/left" + VIEW.JSP.getVar());
        logger.info("/sysLeft.action");
        return VIEW.Pages.getVar() + "sys/left" + VIEW.JSP.getVar();
    }

    //图形报表模块
    @RequestMapping(value = "/statMain.action")
    public String statMain(){
        logger.info("/statMain.action");
        return VIEW.Pages.getVar() + "stat/main" + VIEW.JSP.getVar();
    }

    @RequestMapping(value = "/statLeft.action")
    public String statLeft(){
        logger.info("/statLeft.action");
        return VIEW.Pages.getVar() + "stat/left" + VIEW.JSP.getVar();
    }
