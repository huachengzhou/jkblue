...
public class FactoryServiceImpl implements FactoryService {
    ...
    @Override
    public List<Factory> findPage(Page page) throws ServiceException {
        return null;
    }
    ...
    @Override
    public List<Factory> find(Map paraMap) throws ServiceException {
    ...
    public List<Factory> getFactoryList() throws ServiceException {
        String startState = FactoryState.FACTORY_STATE_START.getState();
        Map<String, Object> map = new HashMap<>();
        map.put("state", startState);
        return factoryMapper.find(map);
    }
    ...
    @CacheEvict(cacheNames = {"factoryServiceCache"}, allEntries = true, keyGenerator = "keyGenerator")
    @Override
    public void insert(Factory factory) throws ServiceException {
        factoryMapper.insertFactory(factory);
    }

    @CacheEvict(cacheNames = {"factoryServiceCache"}, allEntries = true, keyGenerator = "keyGenerator")
    @Override
    public void update(Factory factory) throws ServiceException {
