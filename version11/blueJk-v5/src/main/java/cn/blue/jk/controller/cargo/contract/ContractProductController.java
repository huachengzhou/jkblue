...
public class ContractProductController extends BaseController {
    ...
    public String addContractProduct(Map<String, Object> map, ContractProduct contractProduct) throws ControllerException, Exception {
    ...
    public String update(ContractProduct contractProduct, @RequestParam(value = "contractId") String contractId, Model model) {
