...
<body>
	<script>
        ...
        function formSubmitA (){
            document.forms.namedItem("formNameJK").action = "${pageContext.request.contextPath}/cargo/contract/insert.action";
			document.forms.namedItem("formNameJK").submit();
        }
...
<div>
    <div>
		...
		<form method="post" id="formNameJK" name="formNameJK">
	        <tr>
