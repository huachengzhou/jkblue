...
public class ContractProductServiceImpl implements ContractProductService {
    ...
    @Cacheable(cacheNames = {"ContractProductServiceCache"}, keyGenerator = "keyGenerator")
    @Override
    public List<ContractProduct> find(Map map) throws Exception {
        return contractProductMapper.find(map);
    }

    @Cacheable(cacheNames = {"ContractProductServiceCache"}, keyGenerator = "keyGenerator")
    @Override
    public List<ContractProduct> findContractId(String contractId) throws Exception {
    ...
    @Cacheable(cacheNames = {"ContractProductServiceCache"}, keyGenerator = "keyGenerator")
    @Override
    public ContractProduct get(Serializable id) throws Exception {
