            ...
            <div style="height:29px;">
                ...
                <div id="mask">
                    <div id="menuContent"><span id="topmenu"
                            ...
                            id="tm_separator"></span><span id="topmenu"
                                                           onclick="top.leftFrame.location.href='${pageContext.request.contextPath}/sysLeft.action';top.main.location.href='${pageContext.request.contextPath}/sysMain.action';linkHighlightMenu(this);">系统管理</span>
                    </div>
                </div>
