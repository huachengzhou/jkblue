...
public interface ContractService {
    ...
    public List<Contract> find(Map paraMap) throws ServiceException;            //带条件查询，条件可以为null，既没有条件；返回list对象集合

    public Contract get(Serializable id) throws ServiceException;            //只查询一个，常用于修改
