...
public class RoleController {
    ...
    public String toAddRole(Role role, @RequestParam(value = "pid") String pid) throws Exception {
    ...
    public String removeRole(@RequestParam(value = "rid") String rid) throws Exception {
