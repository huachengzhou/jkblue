...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/cargo/packinglist/insert.action','_self');">确定</a></li>
<li id="back"><a href="${pageContext.request.contextPath}/cargo/export/list.action">返回</a></li>
</ul>
    </div>
</div>
</div>
