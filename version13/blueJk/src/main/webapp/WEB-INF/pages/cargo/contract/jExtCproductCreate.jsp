...
<head>
	...
	<script>
        function formSubmitA (url,sTarget){
            var urlDecoderProductRequest = document.getElementById('urlDecoderProductRequest').value;
            document.getElementById('urlDecoderProductRequest').value = encodeURI(urlDecoderProductRequest);
            var urlDecoderProductRequest = document.getElementById('urlDecoderProductRequest').value;
            document.getElementById('urlDecoderProductRequest').value = encodeURI(urlDecoderProductRequest);
