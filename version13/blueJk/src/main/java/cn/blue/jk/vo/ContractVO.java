...
public class ContractVO implements Serializable {
    ...
    private List<ContractProductVO> contractProducts = new ArrayList<>();        //合同下货物的集合

    private String cpnum; //合同下货物的数量
    private String extnum; //合同下附件的数量
    ...
    public Double getTotalAmount() {
        List<ContractProductVO> cpv = getContractProducts();
        double num = 0;
        for (ContractProductVO c:cpv){
            num+=c.getAmount();
        }
        return num;
    }
    ...
    public String getCpnum() {
        cpnum = ""+getContractProducts().size();
        return cpnum;
    }
    ...
    public String getExtnum() {
        ...
        int size = 0;
        for (ContractProductVO c:cpv){
            size = size+ c.getExtCproducts().size();
        }
        return size+"";
    }
