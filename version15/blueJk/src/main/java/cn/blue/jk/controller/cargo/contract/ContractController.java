 ...
 */
@Controller
public class ContractController extends BaseController {//contract_his_c
     ...
     * @return
     */
    @RequestMapping(value = "/cargo/contracthis/pigeinhole.action")
    public String pigeinhole(@RequestParam(value = "id")String id)throws ControllerException{
        if (id!=null){
            String[] ids = id.split(",");
            contractService.insert(ids);
        }
