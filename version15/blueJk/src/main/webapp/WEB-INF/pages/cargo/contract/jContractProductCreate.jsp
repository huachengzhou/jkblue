...
<head>
	...
	<script>
        function formSubmitA (url,sTarget){
			...
			if (isNull(packingUnit)&&isNull(cnumber)&&isNull(productNo)){
			    if (isNull(productDesc)&&isNull(orderNo)&&isNull(price)){
			        if (isNull(boxNum)){
                        formJK.submit();
					}
				}
...
<body>
<form method="post" enctype="multipart/form-data" name="formJK">
...
<div id="innerMenubar">
    <div id="navMenubar">
		<ul>
			<li id="save"><a href="#" onclick="formSubmitA('${pageContext.request.contextPath}/cargo/contractproduct/insert.action','_self');">确定</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" id="loadingRate" value="不用填写" name="loadingRate"/></td>
	            <td class="columnTitle_mustbe">箱数：</td>
	            <td class="tableContent"><input type="text" id="boxNum" name="boxNum" /></td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="productDesc" id="productDesc" style="height:120px;"></textarea></td>
	        </tr>
		</table>
	</div>
</div>
