...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/cargo/packinglist/update.action','_self');">确定</a></li>
<li id="back"><a href="${pageContext.request.contextPath}/cargo/packinglist/list.action">返回</a></li>
</ul>
    </div>
</div>
</div>
