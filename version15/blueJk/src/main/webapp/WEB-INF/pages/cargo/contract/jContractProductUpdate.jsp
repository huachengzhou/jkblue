...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/cargo/contractproduct/update.action','_self');">确定</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
					<img src="${pageContext.request.contextPath}/${obj.productImage}" style="height:100px;width:200px;">
					<input type="file" name="productImageC"/>
				</td>
	        </tr>
	        <tr>
