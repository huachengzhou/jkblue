...
//			alert((0-currLeft) <= maxOffset);
        ...
        function logout() {
            return formSubmit("${ctx}/sys/logout.action", "_top");
        }
    </script>
            ...
            <div style="height:29px;">
                ...
                <div id="mask">
                    <div id="menuContent">
                        ...
                        <span id="tm_separator"></span><span id="topmenu" onclick="top.leftFrame.location.href='cargoLeft.action';top.main.location.href='cargoMain.action';linkHighlightMenu(this);">货运管理</span>
                        <span id="tm_separator"></span><span id="topmenu" onclick="top.leftFrame.location.href='baseinfoLeft.action';top.main.location.href='baseinfoMain.action';linkHighlightMenu(this);">基础信息</span>
                        <span id="tm_separator"></span><span id="topmenu" onclick="top.leftFrame.location.href='${pageContext.request.contextPath}/sysLeft.action';top.main.location.href='${pageContext.request.contextPath}/sysMain.action';linkHighlightMenu(this);">系统管理</span>
                        <span id="tm_separator"></span><span id="topmenu" onclick="top.leftFrame.location.href='${pageContext.request.contextPath}/statLeft.action';top.main.location.href='${pageContext.request.contextPath}/statMain.action';linkHighlightMenu(this);">图形统计报表模块</span>
                    </div>
                </div>
