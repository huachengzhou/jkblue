...
public class UserController {
    ...
    public String toAddUser(User user, @RequestParam(value = "rid") String rid) throws ControllerException,Exception {
     ...
     * @return
     */
    @RequestMapping(value = "/sys/toUserCheck.action",method = RequestMethod.POST)
    public @ResponseBody String toUserCheck(@RequestParam(value = "username") String username){
        String value = "";
        ...
        System.out.println("约束 username:"+username);
        return value;
    }
    ...
    public String toUserView(@RequestParam(value = "uid",defaultValue = "1") String uid, Map<String, Object> map)throws ControllerException {
